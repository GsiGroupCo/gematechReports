...
import { initialValue, validationSchema } from './ExcelPermisosForm.form'; 
import { useForm } from '@inertiajs/react';


const ExcelPermisosForm = ({ onClose }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formValue) => { 
      ...
      if (enlace) {
        enlace.href = `/getReportePermisos/${formValue.date_initial}/${formValue.date_finish}`;
        enlace.click();
      }
      onClose();
    }
...
export default ExcelPermisosForm;