...
import EditHoras from "../forms/EditHoras";
import DesaprobarHora from "../forms/DesaprobarHora";
import DesautorizarHora from "../forms/DesautorizarHora";
                    ...
                    <div className="w-full h-full bg-gray-200 flex flex-col justify-start items-start justify-items-center overflow-hidden overflow-y-auto">
                        <div className='w-full h-auto bg-gray-200 gap-2 flex justify-evenly items-center justify-items-center p-2 '>
                            <input 
                                ...
                                onChange={(e) => FiltroPendientesAprobar(e.target.value.toLowerCase())}
                            />
                        </div>
                        <div  className=' hidden w-full h-auto border-b-2 cursor-pointer md:flex flex-col md:flex-row justify-center items-center justify-items-center bg-white'>
                            <div className='w-full py-4 md:w-full h-full flex flex-col md:flex-row justify-center items-center justify-items-center bg-[#323c7c] text-white'>
                                <div className='w-full flex '> 
                                    <div className={`${Auth ? 'w-full md:w-[19%]' : 'hidden'} h-auto flex justify-center items-center`}>
                                        <span className='font-bold'> Nombre </span>
                                    </div>
                                    <div className={`${Auth ? 'w-full md:w-[19%]' : 'w-full md:w-[25%]'} h-auto flex justify-center items-center`}>
                            ...
                            ?  
                                HorasPendientesAprobar.map((horasExtras) => (
                                    <div key={horasExtras.horasextras_id} className='w-full  h-auto border-b-2   cursor-pointer  px-4 py-2  flex flex-col md:flex-row justify-center items-center justify-items-center gap-3 bg-white'>
                                        ...
                                        <div className={` ${Auth ? 'w-full md:w-[500px] h-full flex flex-col md:flex-row justify-center items-end justify-items-center gap-3' : 'hidden' } `}>
                                            <div onClick = { () => AprobarHora( horasExtras.horasextras_id )} className='w-full md:w-1/4 h-auto px-4 py-2 flex justify-center items-center text-white bg-green-500 hover:bg-green-800 hover:border-green-500 border border-white rounded-md hover:text-white transition duration-700 ease-out font-bold '>
                                                Aprobar
                                            </div>
                                            <div onClick = { () => { 
                                                 setDesaprobar(false)
                                                ...
                                                className='w-full md:w-1/4 h-auto px-4 py-2 text-white bg-yellow-500 hover:bg-yellow-800 hover:border-yellow-500 cursor-pointer border border-white rounded-md hover:text-white transition duration-700 ease-out font-bold flex justify-center items-center'>
                                                Editar
                                            </div>
                                            ...
                                            <div onClick = { () => { 
                                                ...
                                                className='w-full md:w-1/4 h-auto px-4 py-2 text-white bg-red-500 hover:bg-red-800 hover:border-red-500 cursor-pointer border border-white rounded-md hover:text-white transition duration-700 ease-out font-bold flex justify-center items-center'>
                                                Desaprobar
                                            </div>
                                        </div>
                                    </div>
                        ...
                        }  
                        {
                            Desaprobar ? (
                                <Modal
                                    isVisible = { ModalShow }
                                    onClose   = { () => setModalShow(false) }
                                    tittle    = {` Detalles de desapruebo `}
                                >
                                    <DesaprobarHora HoraData = { HoraSelected } onClose = { () => ModalShow(false) } />
                                </Modal>
                            ) : null
                        }
                        <Modal
                        ...
                        </div>
                        {
                            ...
                            ?  
                                HorasPendientesAutorizar.map((horasExtras) => (
                                    <div key={horasExtras.horasextras_id} className='w-full  h-auto border-b-2   cursor-pointer  px-4 py-2  flex flex-col md:flex-row justify-center items-center justify-items-center gap-3 bg-white'>
                                        <div className='w-full md:w-full h-full flex flex-col text-center md:flex-row justify-center items-center justify-items-center'>
                                            <div className={`${Auth ? 'w-[20%]' : 'hidden'} h-auto flex justify-center items-center`}>
                                                <span className='font-semibold'> {horasExtras.responsable.nombre}</span>
                                            </div>
                                            <div className={`${Auth ? 'w-[20%]' : 'w-[25%]'} h-auto flex justify-center items-center`}>
                                                <span className='font-semibold'> {horasExtras.ot}</span>
                                            </div>
                                            <div className={`${Auth ? 'w-[20%]' : 'w-[25%]'} h-auto flex justify-center items-center`}>
                                                <span className='font-semibold'> {horasExtras.fecha.toString()}</span>
                                        ...
                                        <div className={` ${Auth ? 'w-full md:w-[500px] h-full flex flex-col md:flex-row justify-center items-center justify-items-center gap-3' : 'hidden' } `}>
                                            <div onClick = { () => AutorizarHora( horasExtras.horasextras_id )}   className='w-full md:w-1/2 h-auto px-4 py-2 text-white bg-green-500 hover:bg-green-800 hover:border-green-500 cursor-pointer border border-white rounded-md hover:text-white transition duration-700 ease-out font-bold flex justify-center items-center'>
                                                Autorizar
                                            </div>
                                            <div className='w-full md:w-1/4 h-auto px-4 py-2 text-white bg-blue-500 hover:bg-blue-800 hover:border-blue-500 cursor-pointer border border-white rounded-md hover:text-white transition duration-700 ease-out font-bold flex justify-center items-center' onClick={ () => {
                                                setHoraSelected({
